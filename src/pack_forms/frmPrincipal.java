...
public class frmPrincipal extends javax.swing.JFrame {
    ...
    public frmPrincipal() {
        initComponents(); 
        ImageIcon imagen = new ImageIcon("src/pack_imagenes/intro.gif");
    ...
    private void initComponents() {
        ...
        btnIniciar.setBounds(270, 300, 90, 30);

        lblFondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pack_imagenes/intro.gif"))); // NOI18N
